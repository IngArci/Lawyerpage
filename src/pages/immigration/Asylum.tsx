        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {asylumBases.map((base, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow border-t-4 border-amber-600">
                ...
                <div>
                  <p className="text-sm font-semibold text-slate-900 mb-2">Ejemplos:</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-xl transition-shadow">
              ...
              <h4 className="font-semibold text-slate-900 mb-2">Entrevista/Audiencia</h4>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-xl transition-shadow">
              ...
              <h4 className="font-semibold text-slate-900 mb-2">Decisión</h4>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-xl transition-shadow">
              ...
              <h4 className="font-semibold text-slate-900 mb-2">Green Card</h4>

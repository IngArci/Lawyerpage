...
export default function Residency() {
  ...
  const processingTimes = [
    {
      labelEs: "Familiares Inmediatos",
      labelEn: "Immediate Relatives",
      valueEs: "10-18 meses",
      valueEn: "10-18 months",
    },
    {
      labelEs: "Preferencias Familiares",
      labelEn: "Family Preferences",
      valueEs: "1-10+ años",
      valueEn: "1-10+ years",
    },
    {
      labelEs: "Empleo (EB-1/EB-2)",
      labelEn: "Employment (EB-1/EB-2)",
      valueEs: "1-3 años",
      valueEn: "1-3 years",
    },
    {
      labelEs: "Renovación (I-90)",
      labelEn: "Renewal (I-90)",
      valueEs: "6-12 meses",
      valueEn: "6-12 months",
    },
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {language === "es" ? "Formas de Obtener la Residencia Permanente" : "Ways to Obtain Permanent Residence"}
          </motion.h2>
          ...
          >
            ...
            <div className="space-y-4">
              {processingTimes.map((row, i) => (
                <div key={i} className={`flex justify-between items-center ${i < processingTimes.length - 1 ? "border-b pb-3" : ""}`}>
                  <span className="font-semibold text-slate-900">
                    {language === "es" ? row.labelEs : row.labelEn}
                  </span>
                  <span className="text-amber-600 font-semibold">
                    {language === "es" ? row.valueEs : row.valueEn}
                  </span>
                </div>
              ))}
            </div>

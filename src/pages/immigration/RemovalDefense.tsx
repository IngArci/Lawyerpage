    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-br from-red-900 to-orange-900 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-red-100 max-w-3xl">
            Si estás en proceso de deportación, no estás solo. Nuestros abogados expertos 
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            {defenseStrategies.map((strategy, index) => (
              <div key={index} className="bg-white p-8 rounded-lg shadow-md">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-3">Requisitos principales:</h4>
                  <ul className="space-y-2">
          ...
          <div className="mt-16 bg-gray-100 p-8 rounded-lg">
            ...
            <div className="grid md:grid-cols-5 gap-4">
              <div className="text-center">
                <div className="w-12 h-12 bg-red-900 text-white rounded-full flex items-center justify-center mx-auto mb-3 font-bold">
                  1
                </div>
                <h4 className="font-semibold text-gray-900 mb-2 text-sm">Master Calendar</h4>
              ...
              <div className="text-center">
                ...
                <h4 className="font-semibold text-gray-900 mb-2 text-sm">Individual Hearing</h4>
              ...
              <div className="text-center">
                ...
                <h4 className="font-semibold text-gray-900 mb-2 text-sm">Evidencia</h4>
              ...
              <div className="text-center">
                ...
                <h4 className="font-semibold text-gray-900 mb-2 text-sm">Decisión</h4>
              ...
              <div className="text-center">
                ...
                <h4 className="font-semibold text-gray-900 mb-2 text-sm">Apelación</h4>
          ...
          {/* Emergency CTA */}
          <div className="mt-16 bg-red-900 text-white rounded-lg p-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                to="/contacto"
                className="inline-block bg-white text-red-900 px-8 py-3 rounded-md hover:bg-red-50 transition font-semibold"
              >
                Contacto Inmediato
              </Link>
              <a 
                href="tel:+1234567890"
                className="inline-block border-2 border-white px-8 py-3 rounded-md hover:bg-white hover:text-red-900 transition font-semibold"
              >
                Llamar: (123) 456-7890
              </a>
            </div>

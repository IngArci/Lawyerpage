      ...
      <div className="bg-slate-900 text-white py-2">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-2 sm:gap-4 text-sm">
            <a href="tel:+1234567890" className="flex items-center gap-2 hover:text-amber-400 transition">
              <Phone className="w-4 h-4" />
              <span>(123) 456-7890</span>
            </a>
            <a href="mailto:info@abogadoinmigracion.com" className="flex items-center gap-2 hover:text-amber-400 transition">
      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex justify-between items-center">
          <Link to="/" className="flex items-center">
            <h1 className="text-2xl font-bold text-slate-900">Abogados de Inmigración</h1>
          </Link>
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            <Link to="/acerca" className="text-gray-700 hover:text-slate-900 transition whitespace-nowrap">
              {t("nav.acerca")}
            </Link>
            ...
            <Link to="/recursos" className="text-gray-700 hover:text-slate-900 transition whitespace-nowrap">
              {t("nav.recursos")}
            </Link>

            <Link to="/oportunidades" className="text-gray-700 hover:text-slate-900 transition whitespace-nowrap">
              {t("nav.trabajo")}
            </Link>
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden mt-4 pb-4 flex flex-col gap-4">
            ...
            <Link to="/acerca" onClick={() => setMobileMenuOpen(false)} className="text-gray-700 hover:text-slate-900 transition">
              {t("nav.acerca")}
            </Link>
            ...
            <Link to="/recursos" onClick={() => setMobileMenuOpen(false)} className="text-gray-700 hover:text-slate-900 transition">
              {t("nav.recursos")}
            </Link>

            <Link to="/oportunidades" onClick={() => setMobileMenuOpen(false)} className="text-gray-700 hover:text-slate-900 transition">
              {t("nav.trabajo")}
            </Link>
